            ...
            <div class="col-md-12 mt-5">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div
                            class="card-tools"
                            v-if="$gate.isAdminOrManegerOrOwner()"
                        >
                            <div class="input-group input-group-sm hidden-xs">
                                <button
                                    class="btn btn-success btn-sm mr-3 m-2"
                                    @click="newModalSupplier"
                                >
                        ...
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
                                    <th v-if="$gate.isAdminOrManegerOrOwner()">
                                        Modify
                                    </th>
                                </tr>
                                ...
                                >
                                    ...
                                    <td v-if="$gate.isAdminOrManegerOrOwner()">
                                        <a
                                            href="#"
                                            @click="editModalSupplier(supplier)"
                                        >
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                >
                                    <td>{{ material.id }}</td>
                                    <td>
                                        {{ material.supplier.name | upText }}
                                    </td>
                                    <td>
                                        <router-link
                                            :to="'/material/' + material.id"
                                        >
                                            {{ material.name | upText }}
                                            {{ material.finish | upText }}
                                        </router-link>
                                    </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            @submit.prevent="
                                editmode ? updateSupplier() : createSupplier()
                            "
                            @keyup.enter.prevent="
                                editmode ? updateSupplier() : createSupplier()
                            "
                        ...
                        >
                            ...
                            <div class="form-group">
                                <select
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': form.errors.has('finish')
                                    }"
                                >
                                    <option value disabled selected
                                        >- Finish -</option
                            ...
                            <div class="form-group">
                                <select
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': form.errors.has('range')
                                    }"
                                >
                                    <option value disabled selected
                                        >- Range -</option
        ...
        >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addNewLabel">
                            {{ editmode ? "Edit Finish" : "Create New Finish" }}
                        </h5>
                        <button
                            type="button"
                            class="close"
                    ...
                    <div class="modal-body">
                        <form
                            @submit.prevent="
                                editmode ? updateFinish() : createFinish()
                            "
                            @keyup.enter.prevent="
                                editmode ? updateFinish() : createFinish()
                            "
...
export default {
    ...
    methods: {
        ...
        getFinishes() {
            axios.get("api/finish").then(response => {
        ...
        updateTexture(e) {
            ...
            if (file["size"] < 2111775) {
                reader.onloadend = file => {
                    this.form.texture = reader.result;
                };
